...
# 指定 torch版本 + 安装 vllm
- 假设已经安装了 torch torchvision torchaudio

```
git clone https://github.com/vllm-project/vllm.git
cd vllm

python use_existing_torch.py <========== 注意这里
...
cd LMCache
# git checkout v0.2.1 # update: 使用默认 dev分支
uv pip install -e .
...
python -c "from lmcache.integration.vllm.utils import ENGINE_NAME"
# 根据错误补安装, 直到测试1通过 
