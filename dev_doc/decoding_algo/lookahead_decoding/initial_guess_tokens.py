...
class NgramProposer:
    ...
    def __init__(self, min_n=2, max_n=3, k=1, max_model_len=1024):
...
def _find_subarray_kmp(
    ...
    print(f"_find_subarray_kmp, n={n}, k={k}, context_token_ids={context_token_ids}")
...
if __name__ == "__main__":
    processor = NgramProposer(min_n=2, max_n=2, k=2)
    context_token_ids = np.array([1, 2, 3, 4, 2, 3])
    result = processor.propose(context_token_ids)
    print(result)
